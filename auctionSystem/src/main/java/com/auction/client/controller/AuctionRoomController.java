...
public class AuctionRoomController {
    ...
    @FXML
    private Label auctionIdLabel, itemNameLabel, sellerLabel, statusLabel, currentPriceLabel,
            stepPriceLabel, minimumBidLabel, highestBidderLabel, scheduleLabel, messageLabel, descriptionLabel;
    @FXML
